...
const RAW_FIRMS: PropFirm[] = [
  ...
  },
  {
    ...
    color: '#22d3ee',
    accounts: [
      { size: 25000,  price: 125, resetPrice: 63  },
      { size: 50000,  price: 150, resetPrice: 75  },
      { size: 100000, price: 200, resetPrice: 100 },
      { size: 150000, price: 275, resetPrice: 138 },
      { size: 250000, price: 475, resetPrice: 238 },
    ],
    profitSplit: 90,
    drawdownType: 'eod',
    maxDrawdown: 6,
    ...
    newsTrading: true,
    instruments: ['ES', 'NQ', 'CL', 'GC', 'RTY', 'YM', 'ZB', '6E'],
    payoutSplit: '90% after first $500 to firm per funded account',
    payoutSpeed: 'On request',
    liveAccount: true,
    hasPricePromos: false,
    highlights: [
      'One of the original futures prop firms',
      'EOD drawdown — very trader-friendly',
      'Live funded account pathway',
      'News trading allowed',
    ],
    lastVerified: '2026-05-15',
  },
  {
    ...
    color: '#e879f9',
    accounts: [
      { size: 25000,  price: 110, resetPrice: 55  },
      { size: 50000,  price: 160, resetPrice: 80  },
      { size: 100000, price: 210, resetPrice: 105 },
      { size: 200000, price: 360, resetPrice: 180 },
    ],
    profitSplit: 85,
    drawdownType: 'eod',
    maxDrawdown: 6,
    ...
    liveAccount: false,
    hasPricePromos: true,
    promoNote: 'Occasional discount promotions — check site',
    highlights: [
      'EOD drawdown',
      'News trading allowed',
      'Fast 5-day minimum',
