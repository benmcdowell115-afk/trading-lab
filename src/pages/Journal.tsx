...
export function Journal() {
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      ...
      {/* Header */}
      <div className="flex items-center justify-between px-4 md:px-5 py-3 border-b border-slate-800/50 bg-[#06060d] flex-shrink-0 gap-3 flex-wrap">
        <div>
      ...
      {view === 'analytics' ? (
        ...
        <div className="flex flex-1 overflow-hidden flex-col md:flex-row">
          ...
          <div className="flex flex-col flex-1 overflow-hidden min-w-0">
            ...
            {/* Stats bar */}
            <div className="grid grid-cols-4 border-b border-slate-800/50 bg-[#06060d] flex-shrink-0">
              {[
